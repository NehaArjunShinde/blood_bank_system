...
//	BloodBank findOneByEmail(String Email_ID);
	...
	@Query(value = "select * from blood_banks where  Email_ID= :Email_ID and Password= :Password",nativeQuery = true)
	Optional<BloodBank> findByEmailIdAndPassword(String Email_ID, String Password);
